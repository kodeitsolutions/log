    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown {{ setActive('operation') }}  {{ setActive('category') }} {{ setActive('company') }} {{ setActive('unit') }} {{ setActive('user') }} {{ setActive('material') }} {{ setActive('notification') }} {{ setActive('operation/add') }}  {{ setActive('category/add') }} {{ setActive('company/add') }} {{ setActive('unit/add') }} {{ setActive('user/add') }} {{ setActive('material/add') }} {{ setActive('notification/add') }} {{ setActive('operation/search') }}  {{ setActive('category/search') }} {{ setActive('company/search') }} {{ setActive('unit/search') }} {{ setActive('user/search') }} {{ setActive('material/search') }} {{ setActive('notification/search') }}">
